...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Déplacement aléatoire des étoiles avec une plus grande distance
    function animateStars() {
        stars.forEach(star => {
            // Augmenter les valeurs pour un espacement plus large
            const randomX = getRandomPosition(0, container.offsetWidth * 2);  // Multiplier par 2 pour un plus grand espacement horizontal
            const randomY = getRandomPosition(0, container.offsetHeight * 2);  // Multiplier par 2 pour un plus grand espacement vertical

            // Applique les nouvelles positions aléatoires à chaque étoile
            star.style.left = randomX + 'px';
            star.style.top = randomY + 'px';
        });
    }

    // Répéter le mouvement toutes les 2 secondes (2000ms)
